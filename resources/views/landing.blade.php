  ...
  <body>
      	...
      	<div  id="slider"  class="nivoSlider templatemo_slider">
            ...
            <a href="#"><img src="images/slider/img_3_blank.jpg" alt="slide 3" /></a>
             ...
             <div class="templatemo_caption">
                    <div class="templatemo_slidetitle">INMEHE</div>
                    <div class="clear"></div>
                    <h1>Curso de Herbolaria</h1>
                    <div class="clear"></div>
             		<p>Inmehe es un instituto dedicado a la formación en materia de Salud Herbolaria, nuestra misión es la de hacer llegar a todos conocimientos que han pasado de generación en generación a nuestros antepasados</p>
	...
	<div class="container">
        	...
        	<div class="item project-post">
						<div class="templatemo_about_box">
                        	<div class="square_coner">
                     		   <span class="texts-a"><i class="fa fa-pagelines"></i></span>
                      	  </div>
                     	   Salud</div>
						<div class="col-xs-12 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">
								<p>La Salud al alcance de tus manos.</p>
							</div>
						</div>
					</div>
        </div>
        ...
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						...
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">
								<p>Contamos con gran cantidad de cursos para tu formación</p>
							</div>
						</div>
					</div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-3 templatemo_col12 templatemo_margintop10">
        	<div class="item project-post">
						<div class="templatemo_about_box">
                     	   ...
                     	   ¡Todo a tu alcance!</div>
						<div class="col-xs-6 col-sm-6 col-md-3 hover-box" >
							<div class="inner-hover-box">
								<p>Gran contenido aquí.</p>
							</div>
						</div>
					</div>
        </div>
    ...
    <div class="templatemo_reasonbg">
    	<h2>¿Porqué elegirnos?</h2>
       		<p>En INMEHE contamos con profesores excelentemente capacitados para darte el conocimiento que necesites.</p>
    ...
    <div class="templatemo_portfolio" id="templatemo_portfolio">
        	<h2>Cursos y talleres presenciales</h2>
            <p>También realizamos cursos de manera presencial.</p>
    ...
    <div class="section6 templatemo_partner" id="templatemo_partners">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="secHeader">
              <h2 class="text-center">Nuestros clientes satisfechos</h2>
              <p class="text-center">Estos son algunos de nuestros clientes:</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="templatemo_reasonbg">
        ...
        <div class="container">
        	<div class="col-xs-11 templatemo_col12 templatemo_clientwrapper">
                ...
                <p class="templatemo_clientdes">Me han ayudado mucho. </p>
              ...
              <div class="templatemo_clientimage next">
                <p class="templatemo_clientdes">Muchas gracias por toda esta información. </p>
