  ...
  <body>
      ...
      <div class="container templatemo_container">
        <div class="row">
          ...
          <div class="col-sm-9 col-md-9 templatemo_col9">
            ...
            <nav class="mainMenu">
              <ul class="nav">
              <li><a class="menu" href="http://landing.test/">Inicio</a></li>
    ...
    <div class="templatemo_lightgrey" id="templatemo_contact">
        ...
        <div class="row">
          ...
          <div class="container">
        <div class="row">
        <form action="/recibe-form-contacto" method="POST" role="form">
        
          <div class="col-md-3">
           
              <div class="form-group">
                <input name="nombre" type="text" required class="form-control" id="nombre" placeholder="Nombre completo" maxlength="30" value="{{old('nombre') ?? $nombre}}">
                @error('nombre')
                <i>{{$nombre}}</i>
                @enderror
              </div>
              <div class="form-group">
               <input name="correo" type="text" required class="form-control" id="correo" placeholder="Email" maxlength="30" value="{{old('correo') ?? $correo}}">
                @error('correo')
                <i>{{$correo}}</i>
                @enderror
              </div>
          ...
          <div class="col-md-9">
            <div class="txtarea">
              <textarea name="comentario" required rows="10" class="form-control" placeholder="Escribe un comentario" id="comentario">{{old('comentario')}}</textarea>
            </div>
            @error('comentario')
                <i>{{$comentario}}</i>
                @enderror
