...
ddsmoothmenu.init({
  ...
  <body>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="secHeader">
              ...
              <p class="text-center">Esto es lo que nuestros clientes dicen de nosotros:.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="templatemo_lightgrey" id="templatemo_contact">
        ...
        <div class="container">
        	<div class="templatemo_paracenter">
            Estamos ansiosos por comenzar, puedes encontrarnos en la siguiente dirección o llena este formulario y nos contactaremos con usted.
                        </div>
            <div class="clear"></div>
            <div class="container">
        <div class="row">
